...
class Register:
    def __init__(self, root):
        ...
        title = Label(frame1, text="Register Here", font=(
            "times new roman", 30, "bold"), bg="white", fg="green").place(x=50, y=30)

# --------------------------------Row1-------------------------------------------------------------------

        f_name = Label(frame1, text="First Name",
                        font=("times new roman", 15), 
                        bg="white", fg="gray").place(x=50, y=100)

        self.text_fname = Entry(frame1, text="First Name",  font=("times new roman", 15), bg="lightgray")
        ...
        self.text_lname = Entry(frame1, text="Last Name",  font=("times new roman", 15), bg="lightgray")
...
# --------------------------------Row 2-------------------------------------------------------------------
        ...
        self.text_contact = Entry(frame1, text="Contact No.",  font=("times new roman", 15), bg="lightgray")
        ...
        self.text_email = Entry(frame1, text="Email",  font=("times new roman", 15), bg="lightgray")
        self.text_email.place(x=370, y=200, width=250)
# --------------------------------Row 3-------------------------------------------------------------------
        question = Label(frame1, text="Security Question.",
                          font=("times new roman", 15, "bold"), bg="white", fg="gray").place(x=50, y=240)
        self.cmb_ques = ttk.Combobox(frame1, text="Security Question",  
                                     font=("times new roman", 13), state='readonly', justify=CENTER)
        self.cmb_ques['values'] = ("Select", "Your pet name","your birth place", "your fav food")
        self.cmb_ques.place(x=50, y=270, width=250)
        self.cmb_ques.current(0)
        answer = Label(frame1, text="Answer", 
                       font=("times new roman", 15, "bold"),
                       bg="white", fg="gray").place(x=370, y=240)

        self.text_ans = Entry(frame1, text="Answer",  
                              font=("times new roman", 15), bg="lightgray")
        self.text_ans.place(x=370, y=270, width=250)

# --------------------------------Row 3-------------------------------------------------------------------
        password = Label(frame1, text="Password", 
                         font=("times new roman", 15, "bold"), bg="white", fg="gray").place(x=50, y=310)
        ...
        c_pass = Label(frame1, text="Confirm Password", 
                       font=("times new roman", 15, "bold"), bg="white", fg="gray").place(x=370, y=310)

        self.text_c_pass = Entry(frame1, text="Confirm Password",  
                                 font=("times new roman", 15), bg="lightgray")
    ...
    def register_data(self):
        ...
        elif "@" not in self.text_email.get() or "." not in self.text_email.get():
            messagebox.showerror("Error", "Invalid Email Address", parent=self.root)
        elif self.text_password.get() != self.text_c_pass.get():
            messagebox.showerror("Error", "Password or Confirm password should be same", parent=self.root)
        else:
            try:
                ...
                row = cur.fetchone()
                if row != None:
                    messagebox.showerror("Error", "User Already exist, Please try again another email", parent=self.root)
                else:
